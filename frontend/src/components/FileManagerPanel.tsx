import {
  ...
  type FileEntry,
} from '../vendor/protocol/index';
import { formatBytes, formatEta, formatSpeed } from '../vendor/shared/index';
 ...
 * `backend/src/vendor/protocol/filetransfer.ts` for why that constraint exists.
 */
