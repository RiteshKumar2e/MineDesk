import { AuditAction, PROTOCOL_VERSION, parseClientMessage, type ServerMessage } from '../../vendor/protocol/index.js';
import type { SessionStatus } from '../../vendor/types/index.js';
    ...
    socket.on('message', async (raw: Buffer) => {
      ...
      switch (message.type) {
        ...
        case 'session:join': {
          ...
          // doc comment in backend/src/vendor/protocol/signaling.ts.
