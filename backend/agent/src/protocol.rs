...
//! `backend/src/vendor/protocol/signaling.ts` and `backend/src/vendor/protocol/datachannel.ts`.
//!
...
pub enum ServerFrame {
    ...
    /// `backend/src/vendor/protocol/signaling.ts` for the race this closes. The
...
/// mirror `backend/src/vendor/protocol/filetransfer.ts` exactly.
#[derive(Debug, Deserialize)]
#[serde(tag = "type")]
